...
const ForgotPW = () => {
  ...
  return (
    <div className="forgot-pw">
      ...
      <p className='pw-description'>現在使っているメールアドレスを入力してください</p>
      <p className='pw-description'>パスワード再設定用のURLをメールで送信いたします。</p>
      <form onSubmit={handleSubmit}>
        ...
        <a className='forgot-pw' href='login'>ログイン画面にもどる</a>
      </form>
